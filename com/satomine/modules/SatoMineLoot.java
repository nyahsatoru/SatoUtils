...
import com.satomine.b;
import com.satomine.c.c;
import com.satomine.c.d;
import com.satomine.core.MiningSession;
...
public final class SatoMineLoot extends Module {
   ...
   public SatoMineLoot(SatoMineCoordinator coordinator) {
      super(com.satomine.b.b, "satomine-loot", "Collects important mining drops in bounded batches.");
   ...
   private void l() {
      ...
      for(class_1542 entity : entities) {
         com.satomine.c.b policy = this.c(entity.method_6983().method_7909());
         UUID id = entity.method_5667();
         seen.add(id);
         if (policy == com.satomine.c.b.e) {
            this.ob.remove(id);
         } else {
   ...
   private c e() {
      ...
      List<d> eligible = this.ob.values().stream().filter(d::d).filter((candidatex) -> this.b - candidatex.i() >= (long)effectiveSettleDelay).filter((candidatex) -> candidatex.e().method_1025(origin) <= this.b((Double)this.h.get())).sorted(Comparator.comparingInt((candidatex) -> candidatex.j() == com.satomine.c.b.c ? 0 : 1).thenComparingDouble((candidatex) -> candidatex.e().method_1025(origin))).toList();
      if (eligible.isEmpty()) {
         return null;
      } else {
   ...
   private com.satomine.c.b c(class_1792 item) {
      if (((List)this.db.get()).contains(item)) {
         return com.satomine.c.b.e;
      } else if (!((List)this.gb.get()).contains(item) && !this.d(item)) {
         return ((List)this.fb.get()).contains(item) ? com.satomine.c.b.b : com.satomine.c.b.e;
      } else {
         return com.satomine.c.b.c;
      }
   }
