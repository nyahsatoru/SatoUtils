...
import com.nyahsatoru.satoaddon.b.SatoSellGui;
import com.nyahsatoru.satoaddon.b.b;
import com.nyahsatoru.satoaddon.b.c;
...
public final class SatoMineInventory extends Module {
   ...
   public SatoMineInventory(SatoMineCoordinator coordinator) {
      super(com.nyahsatoru.satoaddon.b.b, "sato-auto-sell", "Automatically sells only the items selected in Items to Sell, then resumes mining.");
   ...
   private void b(c._b executor) {
      this.g = executor;
      this.h = "sato-auto-sell-" + String.valueOf(UUID.randomUUID());
      this.t = 0;
      this.x = false;
   }
